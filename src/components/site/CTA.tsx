      ...
      <div className="container-x py-16 lg:py-20 grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="mt-3 text-white/85">
            Same-week appointments available. Call us or book online.
          </p>
        </motion.div>
        <div className="flex flex-wrap items-center gap-5 lg:justify-end">
          <a
            href="#appointment"
            className="inline-flex items-center rounded-full border border-white/70 px-8 py-4 text-sm font-semibold hover:bg-white hover:text-primary transition-colors"
          >
            Book Online
          </a>
