      ...
      <div className="container-x grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
            At Lumina Dental Studio, we're committed to providing high-quality private dental care
            for the whole family. Established in 2009, our Islington practice combines
            state-of-the-art technology with a warm, unhurried approach that puts nervous patients
            at ease.
          </p>
          ...
          <ul className="mt-8 space-y-3">
            {features.map((f, i) => (
              ...
              >
                <span className="grid place-items-center size-6 rounded-full bg-brand-tint text-brand">
          ...
          <a
            href="#appointment"
            className="mt-10 inline-flex items-center rounded-full bg-primary text-primary-foreground px-8 py-4 text-sm font-semibold shadow-soft hover:shadow-elegant hover:-translate-y-0.5 transition-all"
          >
            Book Appointment
          </a>
        </motion.div>
